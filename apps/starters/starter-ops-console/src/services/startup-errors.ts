 ...
 * messages aimed at a first-time starter user. Prints to stderr and
...
export function printStartupError(err: unknown): void {
  ...
  lines.push('');
  lines.push('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  lines.push('  starter-ops-console failed to start');
  lines.push('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  lines.push('');
  ...
  if (code === 'ECONNREFUSED' || /ECONNREFUSED/.test(message)) {
    ...
    lines.push('');
    lines.push('  This usually means you have your own postgres on :5432, not the one');
    lines.push('  `pnpm docker:up` would have started.');
    lines.push('');
    ...
    lines.push('');
    lines.push('  Fix (option B — point the starter at your own postgres):');
    lines.push('    Edit POSTGRES_URI in apps/starters/starter-ops-console/.env');
  ...
  lines.push('');
  lines.push('  Full troubleshooting: apps/starters/starter-ops-console/README.md');
  lines.push('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  lines.push('');
